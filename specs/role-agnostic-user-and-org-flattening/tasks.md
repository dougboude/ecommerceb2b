...
- [x] 1. Establish identity migration scaffolding under migration safety rails
- [x] 1.1 Wire this spec into migration control-plane checkpoints
...
- [x] 1.2 Add identity compatibility adapters
...
- [x] 2. Implement target user schema for org flattening
- [x] 2.1 Add `organization_name` to target user schema with explicit constraints
...
- [x] 2.2 Implement deterministic org-name backfill
...
- [x] 2.3 Add runtime read preference for flattened organization data
...
- [x] 3. Remove role-based identity dependencies
- [x] 3.1 Refactor identity/auth/profile paths to eliminate `User.role` branching
...
- [x] 3.2 Remove runtime dependencies on `Organization.type`
  - Ensure profile and identity display paths no longer depend on organization-type semantics
  - _Requirements: 3.4, 6.2, 6.3_

- [x] 4. Preserve behavior parity through compatibility and cutover
- [x] 4.1 Validate launch-critical identity behavior parity
...
- [x] 4.2 Implement identity cutover and rollback hooks
...
- [x] 5. Checkpoint - Run identity migration validations
...
- [x] 6. Final Checkpoint - Confirm cleanup readiness
